...
class TrainOptions():
  def __init__(self):
    ...
    self.parser.add_argument('--num_domains', type=int, default=2)
    self.parser.add_argument('--style_dim', type=int, default=64)
    self.parser.add_argument('--input_nz', type=int, default=8)
    ...
    self.parser.add_argument('--lambda_mmd', type=float, default=1, help='lambda of mmd loss')
